      ...
      <main className="flex-grow py-12 flex items-center justify-center">
        <div className="w-full max-w-md px-4">
          <div className="glass-card rounded-lg p-8">
            <h1 className="text-2xl font-bold text-white text-center mb-6">Log In to Your Account</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex justify-end">
                <Link to="/forgot-password" className="text-sm text-ctf-blue hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center text-gray-400">
              ...
              <Link to="/register" className="text-ctf-blue hover:underline">
                Sign up
              </Link>
            </div>
          </div>
